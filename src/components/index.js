...
export EditRedirectBlock from '@plone/volto/components/manage/Blocks/Redirect/Edit';
export ViewRedirectBlock from '@plone/volto/components/manage/Blocks/Redirect/View';
